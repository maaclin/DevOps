...
Networking: Understanding how systems talk to each other, from TCP/IP to DNS, routing, and firewalls.
Linux: Mastering the Linux OS, including system administration, file management, and command-line wizardry.
Bash Scripting: Writing scripts to automate tasks and make my life easier on the command line.
Terraform: Learning infrastructure as code to provision and manage cloud resources like a pro.
